    ...
    export default {
        ...
        methods:{
            editProject(project){
                ...
                this.editingProject.feedback = project.project.project_works.find(w => w.type == 'feedback') != 'undefined';
                this.editingProject.integration = project.project.project_works.find(w => w.type == 'integration') != 'undefined';
