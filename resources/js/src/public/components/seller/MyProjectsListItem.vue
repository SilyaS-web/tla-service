<template>
    <div
        ...
        class="profile-projects__row profile-projects__item">
                        ...
                        <div class="card__row card__stats-row">
                            <div class="card__col card__stats-item">
                                ...
                                <div class="card__stats-val">
                                    <span>{{ project.active_bloggers_count }}</span>
                    ...
                    <div class="card__row card__content">
                            ...
                            <div class="card__row card__header">
                                ...
                                <div class="card__platforms">
                                    <a
                                        ...
                                        :href="platform.link"
                                        :class="'card__platform ' + platform.platform.title + ')'"
                                        target="_blank">
                                        <img :src="platform.platform.image" alt="">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card__col card__stats">
                            <div class="card__col card__stats-stats">
                                <div class="card__row card__stats-row">
                                    ...
                                    <div class="card__col card__stats-item">
                                        ...
                                        <div class="card__stats-val">
                                            <span>{{ work.blogger.subscribers }}</span>
                                        </div>
                                    </div>
                                    <div class="card__col card__stats-item">
                                        <div class="card__stats-title">
                                        ...
                                        <div class="card__stats-val">
                                            <span>{{ work.blogger.coverage }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="card__row card__stats-row">
                                    ...
                                    <div class="card__col card__stats-item">
                                        ...
                                        <div class="card__stats-val">
                                            <span>{{ work.blogger.engagement_rate }}</span>
                                        </div>
                                    </div>
                                    <div class="card__col card__stats-item">
                                        <div class="card__stats-title">
                                        ...
                                        <div class="card__stats-val">
                                            <span> {{ project.product_price / (work.blogger.coverage == 0 ? 1 : work.blogger.coverage) * 1000  }} ₽</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card__row" style="text-align: center;">
                                <a href="?tab=profile-projects" class="" style="width: 100%; color: #FE5E00; font-size:16px; font-weight:500; text-decoration:underline; margin-top: -10px;">Подробнее</a>
                            </div>
                            <div class="card__row bloger-item--btns" style="gap:12px; width:100%; flex-wrap: wrap; justify-content: center">
                                <button class="btn btn-primary" @click="acceptWork">
                                    Принять
                                </button>
                                <button class="btn btn-secondary" @click="denyWork">
                                    Отклонить
                                </button>
                            </div>
                        </div>
            ...
            <div
                :data-el="'active-work-list-' + project.id"
                class="profile-projects__row profile-projects__blogers projects-blogers projects-blogers--in_work owl-carousel" >
                <div
                    v-for="activeWork in bloggers_active"
                    :data-id="activeWork.id"
                    class="list-blogers__item bloger-item card">
                    <div class="card__row card__content">
                        <div class="card__col">
                            <div class="card__row card__header">
                                <div
                                    style="'background-image:url(' + activeWork.blogger.user.image + ')'"
                                    class="card__img">
                                    ...
                                    <div
                                        v-if="activeWork.blogger.is_achievement"
                                ...
                                <div class="card__name">
                                    <p class="card__name-name">
                                        {{ activeWork.blogger.user.name }}
                                    </p>
                                    <p style="font-size: 12px">
                                        {{ activeWork.blogger.country.name }}, {{ activeWork.blogger.city }}
                                    </p>
                                </div>
                                <div class="card__platforms">
                                    <a
                                        v-for="platform in activeWork.blogger.platforms"
                                        :href="platform.link"
                                        :class="'card__platform' + platform.platform.title"
                                        target="_blank"><img :src="platform.platform.image" alt=""></a>
                                </div>
                            </div>
                            <div class="card__row card__desc-title">
                                <p style="font-weight: 500; font-size: 18px;">
                            ...
                            <div class="card__row card__desc">
                                <p>
                                    {{ activeWork.blogger.description }}
                                </p>
                            </div>
                        </div>
                        <div class="card__col card__stats">
                            <div class="card__col card__stats-stats">
                                <div class="card__row card__stats-row">
                                    ...
                                    <div class="card__col card__stats-item">
                                        ...
                                        <div class="card__stats-val">
                                            <span>{{ activeWork.blogger.subscribers }}</span>
                                        </div>
                                    </div>
                                    <div class="card__col card__stats-item">
                                        <div class="card__stats-title">
                                        ...
                                        <div class="card__stats-val">
                                            <span>{{ activeWork.blogger.coverage }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="card__row card__stats-row">
                                    ...
                                    <div class="card__col card__stats-item">
                                        ...
                                        <div class="card__stats-val">
                                            <span>{{ activeWork.blogger.engagement_rate }}</span>
                                        </div>
                                    </div>
                                    <div class="card__col card__stats-item">
                                        <div class="card__stats-title">
                            ...
                            <div class="card__col card__column--gender">
                                ...
                                <div class="card__row" style="align-items: center; gap:5px">
                                    <div class="card__diagram-icon"><img src="img/blogers-list/male-icon.svg" alt=""></div>
                                    <div class="card__diagram-line">
                                        <span :style="'width:' + activeWork.blogger.gender_ratio + '%;'"></span>
                                    </div>
                                    <div class="card__diagram-icon"><img src="img/blogers-list/female-icon.svg" alt=""></div>
                                </div>
                            </div>
                            <div class="card__row card__row" style="gap:12px; width:100%; flex-wrap: wrap">
                                <button
                                    v-if="activeWork.status == null"
                                    :data-project-id="project.id"
                                    class="btn btn-secondary" @click="goToChat">
                                    Заявка отправлена
                                </button>
                                <button
                                    v-else
                                    :data-work-id="active_work.id"
                            ...
                            <div
                                ...
                                <div class="card__row card__stats-row" style="width:calc(100% / 2 - 4px)">
                                    <div class="card__col card__stats-item">
                                        ...
                                        <div class="card__stats-val ">
                                            <span>{{ Math.round(project.product_price / (project.completed_works_statistics.total_views == 0 ? 1 : project.completed_works_statistics.total_views) * 1000).toFixed(2)   }} ₽</span>
                                        </div>
                                    </div>
                                    <div class="card__col card__stats-item" style="flex: 1: width: auto">
                                        <div class="card__stats-title">
