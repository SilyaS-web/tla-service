<template>
    <div class="partners tab-content" id="partners">
                        ...
                        <div class="partners__item partners__item--fw partners__item--mobile-only">
                            <div class="partners__item-body">
                                ...
                                <div class="partners__item-text">
                                    Запишите короткое видео (15-60 секунд) с обзором и упоминанием сервиса Adswap (или его мини-ап в телеграм), поставьте #adswap под видео чтобы мы его нашли и получите возможность выиграть 10 000 рублей. Голосованием нашей команды мы выберем лучший рилс, будем учитывать не только просмотры, но и креативность, активность блогера и тд.
                                    <b>Старт конкурса 28 февраля. Итоги подведем 28 марта.</b>
                                </div>
