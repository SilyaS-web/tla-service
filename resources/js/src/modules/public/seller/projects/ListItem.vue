        ...
        openMoreInfo(){
            ...
            if(!options && !this.project.marketplace_category){
                if(this.project.id !== 262) {
                    ...
                    contentEmptyText = 'Запишите короткое видео (15-60 секунд) с обзором и упоминанием сервиса Adswap (или его мини-ап в телеграм), поставьте #adswap под видео чтобы мы его нашли и получите возможность выиграть 10 000 рублей. Голосованием нашей команды мы выберем лучший рилс, будем учитывать не только просмотры, но и креативность, активность блогера и тд.'
                }
            }
