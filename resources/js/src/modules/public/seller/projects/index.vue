<template>
    <div class="profile-projects profile-tab--js" id="projects-list">
        <div class="profile-projects__body">
            ...
            <div
                :class="'profile-projects__items list-projects__items ' + (_list)" style="max-width:1030px">
                <ListItem
        ...
        <app-observe
            :options="{rootMargin: '0px 0px 500px 0px', threshold: [0, 1]}"
            :itemsCount="10"
            ref="appObserver"
