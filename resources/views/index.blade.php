...
<head>
    ...
    <script type="text/javascript" >
        ...
        //     m[i].l=1*new Date();
        //     for (var j = 0; j < document.scripts.length; j++) {if (document.scripts[j].src1 === r) { return; }}
        //     k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src1=r,a.parentNode.insertBefore(k,a)})
