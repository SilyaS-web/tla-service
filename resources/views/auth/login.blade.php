    ...
    <div class="auth__container _container">
        <div class="auth__body">
            ...
            <form class="form auth__form" action="{{ route('login') }}" method="POST">
                ...
                <p class="form-addit">
                    Нет аккаунта? Тогда <a href="{{ route('register') }}">зарегистрируйтесь</a> в нашем сервисе! Авторизуясь, вы даёте на это согласие и принимаете условия <a href="policy">Политики конфиденциальности.</ </p>
            </form>
        </div>
    </div>
</section>
