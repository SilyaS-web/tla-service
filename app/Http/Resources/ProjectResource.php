...
class ProjectResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'product_brand' => $this->marketplace_brand,
            'product_category' => $this->marketplace_category,
            'real_product_name' => $this->marketplace_product_name,
            'product_description' => $this->marketplace_description,
            'product_options' => $this->marketplace_options,
            'product_rate' => $this->marketplace_rate,
